...
<template>
     <div class="container">
        <header>
            ...
            <div class="titulo-container">
                <h1>Relatório de curativos por paciente</h1>
            </div>
        </header>
        ...
        <div v-else>
            <section class="curativo">
                <h2 class="centro">Curativo</h2>
                <h3 class="centro">Paciente não possui curativos.</h3>
            </section>
        </div>
    </div> 
  </template>
  ...
  import { PacienteCurativoRelatorio, criarPacienteCurativoRelatorio } from '@/types/relatorios';
  ...
  onMounted(() => {
    ...
    const storedData = localStorage.getItem('pacienteCurativoRelatorio');
    if (storedData) {
